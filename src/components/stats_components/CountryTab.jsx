...
const CountryTab = ({ countries }) => {
    ...
    return (
        <div className='bg-gray-50 bg-opacity-50 shadow-lg px-5 md:px-10 pt-5 pb-4 w-[90%] md:w-[80%] lg:w-[50%] rounded-md flex flex-col gap-5'>
            <p className='text-gray-700 font-oswald text-lg'>Countries Explored: {countries.length}</p>
