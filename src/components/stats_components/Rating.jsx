...
function Rating({ data }) {
    ...
    return (
        <div className='w-[90%] md:w-[80%] lg:w-[50%] bg-gray-50 bg-opacity-50 rounded-lg shadow-lg p-6'>
            <div className='flex gap-5 flex-col justify-between items-center'>
                <div className={`w-full`}>
                    <Ratings_Graph data={data.og_data} isMobile={isMobile} />
                    <div className="text-center mt-0 py-1 px-1">
                ...
                <div className={`w-full`}>
                    ...
                    <div className="text-center mt-0 p-3 ">
